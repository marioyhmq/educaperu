const contenidoGestion = {
    ...
    'Gestion.html': {
      ...
      descripcion: 'La gestión empresarial consiste en planificar, organizar, dirigir y controlar todos los recursos de una empresa para alcanzar sus objetivos. Es clave para la eficiencia y el crecimiento sostenible.',
...
const faqsData = {
    "Gestion": [
      {
        pregunta: "¿Qué es la Gestión Empresarial?",
        respuesta: "La gestión empresarial consiste en planificar, organizar y dirigir los recursos de una empresa para lograr sus objetivos de forma eficiente."
      },
      {
        pregunta: "¿Por qué es importante?",
        respuesta: "Permite mejorar procesos, optimizar recursos y aumentar la competitividad en el mercado."
      },
      {
